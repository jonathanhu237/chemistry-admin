# Chunk 2 Reviewed Old Bank Prompt
...
- Chunk: 2
- 实验范围：`19-3-03` 到 `19-6-01`
- 目标原题数：450
- 输出 reviewed artifact：`artifacts/point-aware-question-bank/reviewed_old_bank_chunks/chunk_2_reviewed_v1.json`
- 输出 review report：`artifacts/point-aware-question-bank/reviewed_old_bank_chunks/chunk_2_review_report.md`
