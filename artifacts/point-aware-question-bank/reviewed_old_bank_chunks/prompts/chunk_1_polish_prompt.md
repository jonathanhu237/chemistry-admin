# Chunk 1 Polished Final Prompt

你在 `E:\chemistry-admin` 工作。当前只负责 `chunk_1`，不要处理其他 chunk。
...
- 原始分块 prompt：`E:\chemistry-admin\artifacts\point-aware-question-bank\reviewed_old_bank_chunks\prompts\chunk_1_review_prompt.md`
- 初审稿：`E:\chemistry-admin\artifacts\point-aware-question-bank\reviewed_old_bank_chunks\chunk_1_reviewed_v1.json`
- 语义终审草稿：`E:\chemistry-admin\artifacts\point-aware-question-bank\reviewed_old_bank_chunks\chunk_1_semantic_final_v1.json`
- 语义终审草稿报告：`E:\chemistry-admin\artifacts\point-aware-question-bank\reviewed_old_bank_chunks\chunk_1_semantic_final_report.md`
...
- `E:\chemistry-admin\artifacts\point-aware-question-bank\reviewed_old_bank_chunks\chunk_1_polished_final_v1.json`
- `E:\chemistry-admin\artifacts\point-aware-question-bank\reviewed_old_bank_chunks\chunk_1_polished_final_report.md`

## 核心要求

请基于 `chunk_1_semantic_final_v1.json` 继续，但必须重新实际阅读本 chunk 每一道题的有效版本：
...
```json
{
  ...
  "version": "chunk-1-polished-final-v1",
