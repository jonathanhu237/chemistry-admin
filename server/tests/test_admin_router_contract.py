...
ADMIN_ROUTE_CONTRACTS = [
    ...
    ("GET", "/api/admin/media/assets/{asset_id}/subtitle-tracks"),
    ("POST", "/api/admin/media/assets/{asset_id}/subtitle-tracks"),
    ("PATCH", "/api/admin/media/assets/{asset_id}/subtitle-tracks/{track_id}"),
    ("DELETE", "/api/admin/media/assets/{asset_id}/subtitle-tracks/{track_id}"),
    ("POST", "/api/admin/media/assets/{asset_id}/subtitle-tracks/{track_id}/retry"),
    ("GET", "/api/admin/media/assets/{asset_id}/subtitle-tracks/{track_id}/stream"),
    ("POST", "/api/admin/media/assets/{asset_id}/retry-processing"),
    ("GET", "/api/admin/media/assets/{asset_id}/delete-plan"),
    ("POST", "/api/admin/media/assets/{asset_id}/delete"),
